...
CREATE TABLE `komitent` (
  ...
  PRIMARY KEY (`IdKom`),
  KEY `IdMesKom_idx` (`IdMes`),
  CONSTRAINT `IdMesKom` FOREIGN KEY (`IdMes`) REFERENCES `mesto` (`IdMes`)
...
INSERT INTO `komitent` VALUES (1,'K1','MILUTIN milankovic 1',1),(2,'K2','Milutin Milankovic 2',1),(3,'K3','Niska 3',3),(4,'K4','Novo Sadska',2),(5,'K6','Milutna 2',5);
